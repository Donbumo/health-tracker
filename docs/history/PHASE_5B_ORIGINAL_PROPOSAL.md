# Propuesta original: Fase 5B - Importador asistido universal de JSON no estándar

> Archivo no normativo. Conserva la propuesta original, incluidos nombres y componentes superados. La regla vigente es `../project-rules/phase-5b-universal-json-import-assistant.md` y los schemas de `../../schemas/` tienen prioridad.
