...
TRAINING_PLAN_ALIASES = {
    ...
    "reps_objetivo": "target_reps",
    "rir_objetivo": "target_rir",
    "rpe_objetivo": "target_rpe",
    "descanso_objetivo": "target_rest_seconds",
    "version": "version",
    "bloques": "blocks",
}
...
DOMAIN_RULES: tuple[DomainRule, ...] = (
    ...
    DomainRule(
        ...
        signal_fields=("ingredients", "servings", "yield_weight_g"),
    ),
    DomainRule(
    ...
    DomainRule(
        ...
        path_hints=("plan", "rutina", "training_plan", "programa"),
        aliases=TRAINING_PLAN_ALIASES,
        signal_fields=("days", "exercises", "target_sets", "target_reps"),
    ),
    DomainRule(
